  ...
  render() {
    return (
      <div className="fixed-action-btn">
        <a href="/" className="btn-floating btn-large teal darken-1">
          <i className="large material-icons">mode_edit</i>
        </a>
        <ul>
          <li>
            <a
              className="btn-floating green settings-modal-trigger"
              data-target="primary-settings-modal"
              href="/#primary-settings-modal"
            >
